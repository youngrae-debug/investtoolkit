...
export const metadata = createPageMetadata({
  ...
  description:
    "목표 날짜의 부족분과 월 적립 확대·월 적립과 시작 자금 조합·기간 조정 해결책, 정책 혜택의 대상 가능성과 목표 영향을 계산하는 공식과 가정을 공개합니다.",
  path: "/methodology",
});
